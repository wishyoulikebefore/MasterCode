...
#there is a fixed rotation of simplified tree, so we don't know which direction is the start of a cluster; however, cluster of right direction should count less 
